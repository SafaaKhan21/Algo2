...
import java.util.*;
public class PrimMST extends MSTAlgorithm {
       Graph graph ;
       Vertex []v;
       int total;
    LinkedList<Integer> vertices;
      // Vertex vertices;
    LinkedList<LinkedList<Line>>  adjcList;
  ...
  public   PrimMST(Graph graph ){
    ...
    public void primMST(){
        ...
        // Vertex to Edge Map
        Map<Integer , Line> vertexToEdge = new HashMap<>();
       ...
       for( d=0 ;d<v.length;d++ ){
        ...
        // Continue until the Min-Heap is not empty.
         while(!minHeap.empty()){
            ...
            Line  spanningTreeEdge = vertexToEdge.get(currentVertex);
           ...
           for (int x=0;x<v.length;x++){
            ...
            for(Line edge : getEdges(v[index])){
                //ffff
...
//-------------------------------------------------------------
    ...
    List<Line> getEdges(Vertex vertex){
        
        List<Line> edgeList = new LinkedList<>();
        int i = vertices.indexOf(vertex);
       
     Line help =vertex.getEdges().getHead();
